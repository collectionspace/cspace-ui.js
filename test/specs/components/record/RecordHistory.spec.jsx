...
describe('RecordHistory', function suite() {
  ...
  it('should render a popover when both updated and created information is supplied', function test() {
    ...
    items[0].textContent.should.match(/^Updated Jan \d{2}, 2017 at \d\d?:08 (AM|PM) by updater@collectionspace.org$/);
    items[1].textContent.should.match(/^Created Jan \d{2}, 2017 at \d\d?:12 (AM|PM) by creator@collectionspace.org$/);
  });
  ...
  it('should render a span when only created information is supplied', function test() {
    ...
    span.textContent.should.match(/^Created Jan \d{2}, 2017 at \d\d?:12 (AM|PM) by creator@collectionspace.org$/);
  });
  ...
  it('should render a span when only updated information is supplied', function test() {
    ...
    span.textContent.should.match(/^Updated Jan \d{2}, 2017 at \d\d?:08 (AM|PM) by updater@collectionspace.org$/);
  });
