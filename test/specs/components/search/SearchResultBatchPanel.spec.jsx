...
describe('SearchResultBatchPanel', function suite() {
  ...
  it('should call invoke when the invoke button is clicked in the invocation modal', function test() {
    const recordType = 'group';

    let invokedConfig = null;
    let invokedBatchMetadata = null;
    let invokedInvocationDescriptor = null;

    const invoke = (configArg, batchMetadataArg, invocationDescriptorArg) => {
      invokedConfig = configArg;
      invokedBatchMetadata = batchMetadataArg;
      invokedInvocationDescriptor = invocationDescriptorArg;
    ...
    return new Promise((resolve) => {
      window.setTimeout(() => {
        invokedConfig.should.equal(config);
        invokedBatchMetadata.should.equal(batchMetadata);
        invokedInvocationDescriptor.should.equal(invocationDescriptor);
