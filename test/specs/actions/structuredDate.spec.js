  ...
  describe('parseDisplayDate', function actionSuite() {
    ...
    it('should resolve to an object containing a parsed structured date value', function test() {
      ...
      return store.dispatch(parseDisplayDate('2000'))
        .then((result) => {
          result.should.have.property('value').that.equals(Immutable.fromJS({
            ...
            dateEarliestSingleCertainty: undefined,
            dateEarliestSingleQualifier: undefined,
            dateEarliestSingleQualifierUnit: undefined,
            dateEarliestSingleQualifierValue: undefined,
            dateLatestYear: '2000',
            dateLatestMonth: '12',
            dateLatestDay: '31',
            dateLatestEra: 'urn:cspace:core.collectionspace.org:vocabularies:name(dateera):item:name(ce)\'CE\'',
            dateLatestCertainty: undefined,
            dateLatestQualifier: undefined,
            dateLatestQualifierUnit: undefined,
            dateLatestQualifierValue: undefined,
            scalarValuesComputed: 'false',
          }));
        });
    });
    ...
    it('should resolve to an empty Immutable map value when the display date is blank', function test() {
