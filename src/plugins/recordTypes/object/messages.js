...
export default {
  ...
  field: defineMessages({
    ...
    assocEventOrganization: {
      id: 'field.object.assocEventOrganization',
      defaultMessage: 'Associated event organization',
    },
    assocEventPeoples: {
    ...
    assocEventPerson: {
      id: 'field.object.assocEventPerson',
      defaultMessage: 'Associated event person',
    },
    assocEventPlaces: {
    ...
    fieldCollectionSource: {
      id: 'field.object.fieldCollectionSource',
      defaultMessage: 'Field collection source',
    },
    fieldCollectors: {
    ...
    fieldCollector: {
      id: 'field.object.fieldCollector',
      defaultMessage: 'Field collection collector',
    },
    fieldColEventNames: {
