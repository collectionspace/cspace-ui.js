...
export default () => ({
  optionLists: {
    ...
    emailType: {
      ...
      messages: defineMessages({
        business: {
          id: 'option.emailType.business',
          defaultMessage: 'business',
        },
        personal: {
          id: 'option.emailType.personal',
          defaultMessage: 'personal',
        },
        other: {
          id: 'option.emailType.other',
    ...
    webAddressType: {
      ...
      messages: defineMessages({
        business: {
          id: 'option.webAdressType.business',
          defaultMessage: 'business',
        },
        personal: {
          id: 'option.webAdressType.personal',
          defaultMessage: 'personal',
        },
        other: {
          id: 'option.webAdressType.other',
          defaultMessage: 'other',
        },
      }),
    },
    telephoneNumberType: {
      ...
      messages: defineMessages({
        business: {
          id: 'option.telephoneNumberType.business',
          defaultMessage: 'business',
        },
        home: {
          id: 'option.telephoneNumberType.home',
          defaultMessage: 'home',
        },
        mobile: {
          id: 'option.telephoneNumberType.mobile',
          defaultMessage: 'mobile',
        },
        other: {
          id: 'option.telephoneNumberType.other',
          defaultMessage: 'other',
        },
      }),
    },
    faxNumberType: {
      ...
      messages: defineMessages({
        business: {
          id: 'option.faxNumberType.business',
          defaultMessage: 'business',
        },
        home: {
          id: 'option.faxNumberType.home',
          defaultMessage: 'home',
        },
        other: {
          id: 'option.faxNumberType.other',
          defaultMessage: 'other',
        },
      }),
    },
